...
export default function StatCard({
  ...
  return (
    <div className="bg-white rounded-2xl p-5 border border-garis shadow-[0_2px_10px_rgba(43,54,116,0.06)] hover:shadow-[0_6px_20px_rgba(36,153,239,0.12)] transition-shadow">
